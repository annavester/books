...
from books.views import book_listing, view_book, update_status, update_own,save_book,delete_book,get_latest_read,get_reading_now,add_to_list
...
urlpatterns = patterns('',
    ...
    url(r'^api/v1/latest_read/(?P<count>[0-9]+)/$', get_latest_read),
    url(r'^api/v1/reading_now/(?P<count>[0-9]+)/$', get_reading_now),
)
